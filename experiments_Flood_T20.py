...
parser.add_argument("--T", type=int, default=19, help="number of timesteps to predict")
parser.add_argument("--ntrain", type=int, default=1440, help="training sample size")
parser.add_argument("--nvalid", type=int, default=288, help="valid sample size")
parser.add_argument("--ntest", type=int, default=288, help="test sample size")
