...
parser.add_argument("--txt_suffix", type=str, default="ns_V1e-3_N5000_T50.mat_T20_PeFNN_seed1", help="suffix to add to the results txt")
parser.add_argument("--data_path", type=str, default='/PATH/NS/ns_V1e-3_N5000_T50.mat', help="path to the data")
...
parser.add_argument("--T", type=int, default=40, help="number of timesteps to predict")
