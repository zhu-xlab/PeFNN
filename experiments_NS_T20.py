...
parser.add_argument("--txt_suffix", type=str, default="NavierStokes_V1e-5_N1200_T20.mat_T20_PeFNN_seed1", help="suffix to add to the results txt")
parser.add_argument("--data_path", type=str, default='/PATH/NS/NavierStokes_V1e-5_N1200_T20.mat', help="path to the data")
...
parser.add_argument("--T", type=int, default=10, help="number of timesteps to predict")
