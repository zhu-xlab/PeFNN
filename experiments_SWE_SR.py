...
parser.add_argument("--results_path", type=str, default="/PATH/results/SWE_SR/", help="path to store results")
parser.add_argument("--suffix", type=str, default="seed1", help="suffix to add to the results path")
parser.add_argument("--txt_suffix", type=str, default="2D_rdb_NA_NA.h5_PeFNN_seed1", help="suffix to add to the results txt")
parser.add_argument("--data_path", type=str, default='/PATH/NS/2D_rdb_NA_NA.h5', help="path to the data")
...
parser.add_argument("--ntrain", type=int, default=800, help="training sample size")
